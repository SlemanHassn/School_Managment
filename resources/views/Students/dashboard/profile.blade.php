                        ...
                        <div class="main-profile-overview ">
                            ...
                            <div class=" mg-b-20">
                                <div>
                                    ...
                                    <p class="main-profile-name-text mb-1">Student</p>
                                    <p class="main-profile-name-text">{{ $info->gender->Name }}</p>
                                    <p class="main-profile-name-text">{{ $info->grade->Name }}</p>
                                    <p class="main-profile-name-text">{{ $info->classroom->Name }}</p>
                                    <p class="main-profile-name-text">{{ $info->section->Name }}</p>
