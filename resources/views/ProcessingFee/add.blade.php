...
@endsection
@section('title')
    {{ trans('Fees_Invoices.Add_processing_fees') }}
@stop
@section('page-header')
    <!-- breadcrumb -->
        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('Fees.Accounts') }}</h4><span
                    class="mt-1 text-danger  mr-2 mb-0">/
                    {{ trans('Fees_Invoices.Add_processing_fees') }} {{ $student->name }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('ProcessingFee.store') }}" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label> {{ trans('Fees_Invoices.Student_balance') }} : </label>
